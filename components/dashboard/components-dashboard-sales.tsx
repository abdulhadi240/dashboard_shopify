...
const ComponentsDashboardSales = ({data}) => {
                ...
                <div className="pt-5">
                    <div className="grid gap-6 mb-6 xl:grid-cols-3">
                        <div className="h-full panel xl:col-span-2">
                            <div className="flex items-center justify-between mb-5 dark:text-white-light">
                    ...
                    <div className="grid gap-6 mb-6 sm:grid-cols-2 xl:grid-cols-3">
                        <div className="h-full panel sm:col-span-2 xl:col-span-1">
                            <div className="flex items-center mb-5">
                            ...
                            <div className="space-y-9">
                                <div className="flex items-center">
                                    <div className="h-9 w-9 ltr:mr-3 rtl:ml-3">
                                        <div className="grid rounded-full h-9 w-9 place-content-center bg-secondary-light text-secondary dark:bg-secondary dark:text-secondary-light">
                                            <IconInbox />
                                        </div>
                                    </div>
                                ...
                                <div className="flex items-center">
                                    <div className="h-9 w-9 ltr:mr-3 rtl:ml-3">
                                        <div className="grid rounded-full h-9 w-9 place-content-center bg-success-light text-success dark:bg-success dark:text-success-light">
                                            <IconTag />
                                        </div>
                                    </div>
                                    <div className="flex-1">
                                ...
                                <div className="flex items-center">
                                    <div className="h-9 w-9 ltr:mr-3 rtl:ml-3">
                                        <div className="grid rounded-full h-9 w-9 place-content-center bg-warning-light text-warning dark:bg-warning dark:text-warning-light">
                                            <IconCreditCard />
                                        </div>
                                    </div>
                                    <div className="flex-1">
                        ...
                        <div className="h-full p-0 panel">
                            <div className="absolute flex items-center justify-between w-full p-5">
                                <div className="relative">
                                    <div className="flex items-center justify-center rounded-lg h-11 w-11 bg-success-light text-success dark:bg-success dark:text-success-light">
                                        <IconShoppingCart />
                                    </div>
                                </div>
                    ...
                    <div className="grid gap-6 mb-6 sm:grid-cols-2 xl:grid-cols-3">
                        <div className="h-full pb-0 panel sm:col-span-2 xl:col-span-1">
                            ...
                            <PerfectScrollbar className="relative mb-4 h-[290px] ltr:-mr-3 ltr:pr-3 rtl:-ml-3 rtl:pl-3" options={{ suppressScrollX: true }}>
                                <div className="text-sm cursor-pointer">
                                    <div className="group relative flex items-center py-1.5">
                                        ...
                                        <span className="absolute text-xs opacity-0 badge badge-outline-primary bg-primary-light group-hover:opacity-100 ltr:right-0 rtl:left-0 dark:bg-black">
                                            Pending
                                        </span>
                                    </div>
                                    <div className="group relative flex items-center py-1.5">
                                        ...
                                        <span className="absolute text-xs opacity-0 badge badge-outline-success bg-success-light group-hover:opacity-100 ltr:right-0 rtl:left-0 dark:bg-black">
                                            Completed
                                        </span>
                                    </div>
                                    <div className="group relative flex items-center py-1.5">
                                        ...
                                        <span className="absolute text-xs opacity-0 badge badge-outline-danger bg-danger-light group-hover:opacity-100 ltr:right-0 rtl:left-0 dark:bg-black">
                                            Pending
                                        </span>
                                    </div>
                                    <div className="group relative flex items-center py-1.5">
                                        ...
                                        <span className="absolute text-xs opacity-0 badge badge-outline-dark bg-dark-light group-hover:opacity-100 ltr:right-0 rtl:left-0 dark:bg-black">
                                            Completed
                                        </span>
                                    </div>
                                    <div className="group relative flex items-center py-1.5">
                                        ...
                                        <span className="absolute text-xs opacity-0 badge badge-outline-warning bg-warning-light group-hover:opacity-100 ltr:right-0 rtl:left-0 dark:bg-black">
                                            In progress
                                        </span>
                                    </div>
                                    <div className="group relative flex items-center py-1.5">
                                        ...
                                        <span className="absolute text-xs opacity-0 badge badge-outline-info bg-info-light group-hover:opacity-100 ltr:right-0 rtl:left-0 dark:bg-black">
                                            Completed
                                        </span>
                                    </div>
                                    <div className="group relative flex items-center py-1.5">
                                        ...
                                        <span className="absolute text-xs opacity-0 badge badge-outline-secondary bg-secondary-light group-hover:opacity-100 ltr:right-0 rtl:left-0 dark:bg-black">
                                            Pending
                                        </span>
                                    </div>
                                    <div className="group relative flex items-center py-1.5">
                            ...
                            <div className="border-t border-white-light dark:border-white/10">
                                <button type="button" className="flex items-center justify-center w-full p-4 font-semibold group hover:text-primary">
                                    View All
                        ...
                        <div className="h-full panel">
                            ...
                            <div>
                                <div className="space-y-6">
                                    <div className="flex">
                                        <span className="grid text-base rounded-md h-9 w-9 shrink-0 place-content-center bg-success-light text-success dark:bg-success dark:text-success-light">
                                            SP
                                        </span>
                                        ...
                                        <span className="px-1 text-base whitespace-pre text-success ltr:ml-auto rtl:mr-auto">+$36.11</span>
                                    </div>
                                    <div className="flex">
                                        <span className="grid rounded-md h-9 w-9 shrink-0 place-content-center bg-warning-light text-warning dark:bg-warning dark:text-warning-light">
                                            <IconCashBanknotes />
                                        </span>
                                        <div className="flex-1 px-3">
                                        ...
                                        <span className="px-1 text-base whitespace-pre text-danger ltr:ml-auto rtl:mr-auto">-$16.44</span>
                                    </div>
                                    <div className="flex">
                                        <span className="grid rounded-md h-9 w-9 shrink-0 place-content-center bg-danger-light text-danger dark:bg-danger dark:text-danger-light">
                                        ...
                                        <span className="px-1 text-base whitespace-pre text-success ltr:ml-auto rtl:mr-auto">+$66.44</span>
                                    </div>
                                    <div className="flex">
                                        <span className="grid rounded-md h-9 w-9 shrink-0 place-content-center bg-secondary-light text-secondary dark:bg-secondary dark:text-secondary-light">
                                            <IconNetflix />
                                        </span>
                                        <div className="flex-1 px-3">
                                            <div>Netflix</div>
                                        ...
                                        <span className="px-1 text-base whitespace-pre text-danger ltr:ml-auto rtl:mr-auto">-$32.00</span>
                                    </div>
                                    <div className="flex">
                                        <span className="grid text-base rounded-md h-9 w-9 shrink-0 place-content-center bg-info-light text-info dark:bg-info dark:text-info-light">DA</span>
                                        <div className="flex-1 px-3">
                                            <div>Daisy Anderson</div>
                                            <div className="text-xs text-white-dark dark:text-gray-500">10 Jan 1:00PM</div>
                                        </div>
                                        <span className="px-1 text-base whitespace-pre text-success ltr:ml-auto rtl:mr-auto">+$10.08</span>
                                    </div>
                                    <div className="flex">
                                        <span className="grid rounded-md h-9 w-9 shrink-0 place-content-center bg-primary-light text-primary dark:bg-primary dark:text-primary-light">
                                            <IconBolt />
                                        </span>
                                        <div className="flex-1 px-3">
                                        ...
                                        <span className="px-1 text-base whitespace-pre text-danger ltr:ml-auto rtl:mr-auto">-$22.00</span>
                                    </div>
                                </div>
                            </div>
                        </div>

                        <div className="h-full p-0 overflow-hidden border-0 panel">
                            <div className="min-h-[190px] bg-gradient-to-r from-[#4361ee] to-[#160f6b] p-6">
                                <div className="flex items-center justify-between mb-6">
                                    <div className="flex items-center p-1 font-semibold text-white rounded-full bg-black/50 ltr:pr-3 rtl:pl-3">
                                        <img className="block object-cover w-8 h-8 border-2 rounded-full border-white/50 ltr:mr-1 rtl:ml-1" src="/assets/images/profile-34.jpeg" alt="avatar" />
                                        Alan Green
                                    </div>
                                    <button type="button" className="flex items-center justify-between text-white bg-black rounded-md h-9 w-9 hover:opacity-80 ltr:ml-auto rtl:mr-auto">
                            ...
                            <div className="grid grid-cols-2 gap-2 px-8 -mt-12">
                                <div className="rounded-md bg-white px-4 py-2.5 shadow dark:bg-[#060818]">
                                    <span className="flex items-center justify-between mb-4 dark:text-white">
                                        Received
                                        <IconCaretDown className="w-4 h-4 rotate-180 text-success" />
                                    </span>
                                    ...
                                    <tbody>
                                        <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                            <td className="min-w-[150px] text-black dark:text-white">
                                                <div className="flex items-center">
                                                    <img className="object-cover w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3" src="/assets/images/profile-6.jpeg" alt="avatar" />
                                            ...
                                            <td>$56.07</td>
                                            <td>
                                                <span className="shadow-md badge bg-success dark:group-hover:bg-transparent">Paid</span>
                                            </td>
                                        </tr>
                                        <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                            <td className="text-black dark:text-white">
                                                <div className="flex items-center">
                                                    <img className="object-cover w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3" src="/assets/images/profile-7.jpeg" alt="avatar" />
                                            ...
                                            <td>$126.04</td>
                                            <td>
                                                <span className="shadow-md badge bg-secondary dark:group-hover:bg-transparent">Shipped</span>
                                            </td>
                                        </tr>
                                        <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                            <td className="text-black dark:text-white">
                                                <div className="flex items-center">
                                                    <img className="object-cover w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3" src="/assets/images/profile-8.jpeg" alt="avatar" />
                                        ...
                                        <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                            <td className="text-black dark:text-white">
                                                <div className="flex items-center">
                                                    <img className="object-cover w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3" src="/assets/images/profile-9.jpeg" alt="avatar" />
                                        ...
                                        <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                            <td className="text-black dark:text-white">
                                                <div className="flex items-center">
                                                    <img className="object-cover w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3" src="/assets/images/profile-10.jpeg" alt="avatar" />
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                            <td className="min-w-[150px] text-black dark:text-white">
                                                <div className="flex">
                                                    <img className="object-cover w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3" src="/assets/images/product-headphones.jpg" alt="avatar" />
                                        ...
                                        <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                            <td className="text-black dark:text-white">
                                                <div className="flex">
                                                    <img className="object-cover w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3" src="/assets/images/product-shoes.jpg" alt="avatar" />
                                                    <p className="whitespace-nowrap">
                                        ...
                                        <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                            <td className="text-black dark:text-white">
                                                <div className="flex">
                                                    <img className="object-cover w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3" src="/assets/images/product-watch.jpg" alt="avatar" />
                                                    <p className="whitespace-nowrap">
                                        ...
                                        <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                            <td className="text-black dark:text-white">
                                                <div className="flex">
                                                    <img className="object-cover w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3" src="/assets/images/product-laptop.jpg" alt="avatar" />
                                                    <p className="whitespace-nowrap">
                                        ...
                                        <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                            <td className="text-black dark:text-white">
                                                <div className="flex">
                                                    <img className="object-cover w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3" src="/assets/images/product-camera.jpg" alt="avatar" />
                                                    <p className="whitespace-nowrap">
